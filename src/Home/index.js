    ...
    return (
      <div className={styles.wrapper}>
          ...
          <div className={styles.about__content}>
            ...
            <div className={styles.about__content__right}>
              <div className={styles.about__content__right__title}>
                <h3>Hi Everyone!</h3>
                <p>
                  I'm a developer. I’m extremely passionate about web
                  development and design in all it’s forms and helping
                  businesses and improve their online presence.
                </p>
                <p>
                  Currently, I have graduated Cao Thang college (2015-2018),I
                  have had over 6 months of working experience in businesses
                  (FullStack).But now I want to develop the user interface
                  (FrontEnd) and and do it well
                </p>
                <p></p>
              </div>
            </div>
            ...
            <div className={styles.exp__wrapper}>
              <div data-aos="flip-left" className={styles.exp__content}>
                <div className={styles.exp__img}>
                  <img
                    src="https://linhnguyenvu997.github.io/portolifo/design.png"
                    alt=""
                  />
                </div>
              ...
              <div data-aos="flip-left" className={styles.exp__content}>
                <div className={styles.exp__img}>
                  <img
                    src="https://linhnguyenvu997.github.io/portolifo/inspiration.png"
                    alt=""
                  />
                </div>
                <div className={styles.exp__content__text}>
              ...
              <div data-aos="flip-left" className={styles.exp__content}>
                <div className={styles.exp__img}>
                  <img
                    src="https://linhnguyenvu997.github.io/portolifo/teamwork.png"
                    alt=""
                  />
                </div>
                <div className={styles.exp__content__text}>
        ...
        <div className={styles.footer}>
          © 2019 Lin Nguyễn. All Rights Reserved.
        </div>
      </div>
    );
  }
